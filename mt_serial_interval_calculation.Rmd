...
epi_curve_full <- plot_data %>% 
   ...
   ggplot() +
     ...
     geom_line(aes(dates, trend_cases, color = "7-day average"), size = 1) + 
     scale_color_manual(values = "black") +
     geom_text(aes(x = as.Date("2020-03-03"), y = 195, label = "A"), size = 8, color = "black") + 
     geom_text(aes(x = as.Date("2020-03-31"), y = 195, label = "B"), size = 8, color = "black") + 
     geom_text(aes(x = as.Date("2020-04-30"), y = 195, label = "C"), size = 8, color = "black") + 
     geom_text(aes(x = as.Date("2020-06-04"), y = 195, label = "D"), size = 8, color = "black") + 
     geom_text(aes(x = as.Date("2020-07-04"), y = 195, label = "E"), size = 8, color = "black") + 
     labs(fill = "", color = "") +
     ylab("Number of Reported Cases") +
     xlab("Date of Symptom Onset") +
     scale_x_date(breaks = seq.Date(from = as.Date("2020-03-01"), 
                  ...
                  date_labels = "%d-%B",
                  expand = expansion(mult = 0.015)) +
     scale_y_continuous(breaks = c(seq(0, 200, 20)), labels = c(seq(0, 200, 20)),
                        minor_breaks = c(seq(0, 200, 10)),
                        expand = expansion(mult = c(0.0, 0.04))) +
     theme_minimal() +
     theme(title = element_text(size = 12, colour = "black"),
           panel.grid = element_blank(),
...
ggsave("si_pub_epi_curve_no_labels.jpg", width = 13, height = 7, dpi = 600)
