...
epi_curve_full <- full_data %>% 
   ...
   ggplot() +
     ...
     geom_text(aes(x = as.Date("2020-03-03"), y = 230, label = "A"), size = 8, color = "black") + 
     geom_text(aes(x = as.Date("2020-03-31"), y = 230, label = "B"), size = 8, color = "black") + 
     geom_text(aes(x = as.Date("2020-04-30"), y = 230, label = "C"), size = 8, color = "black") + 
     geom_text(aes(x = as.Date("2020-06-04"), y = 230, label = "D"), size = 8, color = "black") + 
     geom_text(aes(x = as.Date("2020-07-04"), y = 230, label = "E"), size = 8, color = "black") + 
     geom_label(aes(x = as.Date("2020-03-16"), y = 190,
                    label = "Pre-SIP: \n\n Cases = 285 \n SI Pairs = 95 \n Mean SI = 6.84 \n (95% CI: 5.84, 7.87) \n SD SI = 5.56 \n (95% CI: 4.45, 6.80)"),
                fill = NA, color = "black") +
     geom_label(aes(x = as.Date("2020-04-13"), y = 190, 
                    label = "SIP: \n\n Cases = 168 \n SI Pairs = 20 \n Mean SI = 5.54 \n (95% CI: 3.34, 8.26) \n SD SI = 5.30 \n (95% CI: 2.69, 8.76)"),
                fill = NA, color = "black") +
     geom_label(aes(x = as.Date("2020-05-14"), y = 190,
                    label = "Phase 1: \n\n Cases = 99 \n SI Pairs = 25 \n Mean SI = 5.26 \n (95% CI: 3.64, 7.21) \n SD SI = 4.74 \n (95% CI: 2.86, 7.09)"),
                fill = NA, color = "black") +
     geom_label(aes(x = as.Date("2020-06-17"), y = 190, 
                    label = "Phase 2 (June): \n\n Cases = 824 \n SI Pairs = 248 \n Mean SI = 6.23 \n (95% CI: 5.59, 6.85) \n SD SI = 5.32 \n (95% CI: 4.61, 6.05)"),
                fill = NA, color = "black") +
     geom_label(aes(x = as.Date("2020-07-18"), y = 190, 
                    label = "Phase 2 (July): \n\n Cases = 3,417 \n SI Pairs = 195 \n Mean SI = 4.42 \n (95% CI: 3.92, 4.93) \n SD SI = 3.51 \n (95% CI: 2.97, 4.06)"),
                fill = NA, color = "black") +
     labs(fill = "") +
...
ggsave("si_pub_epi_curve3.jpg", width = 13, height = 7, dpi = 600)
```
