...
mt_incidence_data <- incidence(mt_data$dates, last_date = "2020-03-27")
...
# 95% CI for means
qgamma(c(0.025, 0.975), shape = 794, scale = 0.00694)

# Shape and scale of distribution of SDs
egamma(total_results$SI.Moments$Std, ci = TRUE)
# 95% CI for SDs
qgamma(c(0.025, 0.975), shape = 463, scale = 0.00998)
...
# 95% CI for means
qgamma(c(0.025, 0.975), shape = 108, scale = 0.0428)

# Shape and scale of distribution of SDs
egamma(presip_results$SI.Moments$Std, ci = TRUE)
# 95% CI for SDs
qgamma(c(0.025, 0.975), shape = 54, scale = 0.0683)
...
# 95% CI for means
qgamma(c(0.025, 0.975), shape = 27, scale = 0.197)
...
epi_curve_full <- full_data %>% 
   ...
   ggplot() +
     ...
     geom_label(aes(x = as.Date("2020-06-16"), y = 125, 
                    label = "Phase 2: \n\n Cases = 4,217 \n SI Pairs = 372 \n\n Mean SI = 5.29 \n (95% CI: 4.88, 5.76) \n\n SD SI = 4.45 \n (95% CI: 3.97, 4.93)"),
                fill = NA, color = "black") +
     labs(title = "Reported COVID-19 cases in Montana by date of symptom onset",
          subtitle = paste0("Total cases = 4,772; Total SI Pairs = 509; Overall Mean SI = 5.51 (95% CI: 5.13, 5.90); Overall SD SI = 4.62 (95% CI: 4.21, 5.05)"),
          fill = " ") +
...
#ggsave("si_pub_epi_curve2.jpg", width = 13, height = 7)
```
