...
age_count_month_plot <- covid_data %>% 
   ...
   ggplot() +
      ...
      geom_label(aes(x = Sys.Date()-14, y = 80, 
...
age_count_month_plot2 <- covid_data %>% 
   ...
   ggplot() +
      ...
      geom_label(aes(x = Sys.Date()-14, y = 50, 
                    label = "Cases from the shaded \n dates may not yet be \n reflected in the graph."),
                fill = NA) +
      theme_minimal() +
      labs(title = "Weekly COVID-19 cases by age group",
...
age_incidence_plot_line <- covid_data %>% 
   ...
   ggplot() +
      ...
      xlab("") +
      geom_label(aes(x = Sys.Date()-14, y = 400, 
                    label = "Cases from the shaded \n dates may not yet be \n reflected in the graph."),
                fill = NA) +
      scale_x_date(breaks = seq.Date(from = as.Date("2021-01-01"), 
                                    to = as.Date(Sys.Date()), 
...
age_incidence_plot_line <- covid_data %>% 
   ...
   ggplot() +
      ...
      ylab("Incidence per 100,000") +
      xlab("") +
      geom_label(aes(x = Sys.Date()-14, y = 350, 
                    label = "Cases from the shaded \n dates may not yet be \n reflected in the graph."),
                fill = NA) +
      scale_x_date(breaks = seq.Date(from = as.Date("2021-01-01"), 
                                    to = as.Date(Sys.Date()), 
...
epi_curve_test_date <- plot_data %>% 
   ggplot() +
     ...
     geom_label(aes(x = Sys.Date()-10, y = 70, 
                    label = "Cases from the shaded \n dates may not yet be \n reflected in the graph."),
                fill = NA) +
