...
age_count_plot <- covid_data %>% 
   ...
   ggplot() +   
     ...
     labs(title = "COVID-19 Cases by age group",
          subtitle = paste0("Missoula County, 2020. Age under investigation for ", age_na, " cases."), 
...
age_count_month_plot <- um_data %>% 
   ...
   ggplot() +
      ...
      labs(title = "Weekly COVID-19 cases by age group",
        subtitle = paste0("University of Montana, 2020. Data incomplete for ", age_na, " cases."),
        color = "Age group") +
