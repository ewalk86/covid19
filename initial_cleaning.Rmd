...
author: "Ethan Walker"
date: "Started 2 April 2020, Updated 17 April 2020"
output:
...
covid_data_initial <- 
   read_xlsx(paste0(input_path, "Input/mcchd_covid_data_20200416.xlsx"), skip = 1,
...
covid_clean <- covid_data_initial %>% 
   ...
   mutate(symptom_cough = grepl("COUGH|MILD COUGH", symptom_type, ignore.case = TRUE),
          ...
          symptom_nv_diarrhea = grepl("NAUSEA|N/V|DIARRHEA|N/V/D|ABDOMINAL", symptom_type, ignore.case = TRUE),
