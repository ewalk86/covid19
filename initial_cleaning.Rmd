...
author: "Ethan Walker"
date: "Started 2 April 2020, Updated 28 Sept 2020"
output:
...
covid_data_initial <- 
   read_xlsx(paste0(input_path, "COVID data 9.28.20.xlsx"), 
             range = "A2:Y900", 
...
covid_clean <- covid_data_initial %>% 
   ...
   mutate(age = as.numeric(age),
          ...
          age_group3 = cut(age, breaks = c(0, 10, 15, 25, 30, 40, 50, 60, 70, 80, 110),
                          labels = c("0 to 9", "10 to 14", "15 to 24", "25 to 29", 
   ...
   select(case_id, age, age_group, age_group_percent, age_group2, age_group3,
   ...
   mutate(symptom_fever_chill = grepl("FEVER|CHILL|CHILLS|NIGHT SWEAT", symptom_type, ignore.case = TRUE),
          ...
          symptom_sob = grepl("SOB|SHORTNESS OF BREATH|BREATH|BREATHING", symptom_type, ignore.case = TRUE),
          ...
          symptom_congestion = grepl("CONGESTION|RUNNY NOSE|SNEEZING|RHINORRHEA|SINUS", symptom_type, ignore.case = TRUE),
   ...
   mutate(symptom_test_diff = as.duration(interval(symptom_onset_date, test_date)),
          ...
          symptom_onset_date_new = if_else(is.na(symptom_onset_date), 
                                       ...
                                       symptom_onset_date),
          symptom_onset_date_new = if_else(symptoms == "No", test_date,
          ...
          symptom_onset_date_indicator = if_else(symptoms == "No",
          ...
          race = factor(race,
                        levels = c("african american", "american indian or alaskan native",
                                   ...
                                   "white"),
                        labels = c("african american, 0.005", "american indian or alaskan native, 0.027",
                                   "asian, 0.018", "native hawaiian/pacific islander, 0.001", "other, 0.031",
                                   "white, 0.917")),
          ethnicity = fct_collapse(ethnicity,
                                   "hispanic/latino, 0.034" = c("hispanic/latino"),
                                   "not hispanic or latino, 0.891" = 
