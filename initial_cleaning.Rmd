...
covid_data_initial <- 
   read_xlsx(paste0(input_path, "COVID data 10.12.20.xlsx"), sheet = 1,
             range = "A2:AB2000", 
                        col_names = c("case_id", "case_status", "current_hosp", "age", "gender", "race", 
...
covid_clean <- covid_data_initial %>% 
   ...
   select(case_id, case_status, current_hosp, age, age_group, age_group_percent, age_group2, age_group3,
