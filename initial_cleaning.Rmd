...
covid_data_initial <- 
   read_xlsx(paste0(input_path, "Input/mcchd_covid_data_20200412.xlsx"), skip = 1,
                        col_names = c("dob", "gender", "zipcode", "healthcare_worker",
                                      "symptoms", "symptom_type", "symptom_onset_date",
                                      "test_date", "test_lab", "last_exposure_date", 
...
covid_clean <- covid_data_initial %>% 
   ...
   select(case_number, dob, age, age_group, age_group2, gender:epi_linked) %>% 
   ...
   mutate(symptom_cough = grepl("COUGH|MILD COUGH", symptom_type, ignore.case = TRUE),
          ...
          symptom_body_aches = grepl("BODY ACHES|ACHES", symptom_type, ignore.case = TRUE),
          ...
          symptom_nv_diarrhea = grepl("NAUSEA|N/V|DIARRHEA|N/V/D", symptom_type, ignore.case = TRUE),
          symptom_aches = grepl("BODY ACHES|HEADACHE|MYALGIA|HA|H/A|ACHES", symptom_type, ignore.case = TRUE),
          symptom_sinus_throat = grepl("CONGESTION|RUNNY NOSE|SNEEZING|SORE THROAT|RHINORRHEA|SCRATCHY THROAT|THROAT", 
   ...
   mutate(case = 1,
          ...
          chronic_conditions = factor(chronic_conditions, levels = c("y", "n"),
                             labels = c("Yes", "No")),
          community_spread = factor(community_spread, levels = c("y", "n"),
                             labels = c("Yes", "No")),
