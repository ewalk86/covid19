...
age_n <- variant_data_clean %>% 
   ...
   filter(case_episode == "Reinfection Original Case #:") 
...
epi_curve_reinfect <- plot_data %>% 
   ggplot() +
     geom_col(aes(test_date, case, fill = case_episode2), width = 2) +
...
epi_curve_breakthrough <- plot_data %>% 
   ggplot() +
     geom_col(aes(test_date, case, fill = variant), width = 2) +
