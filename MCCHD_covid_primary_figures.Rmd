...
date: "Data as of October 1, 2020"
output: pdf_document
header-includes:
...
age_count_plot <- covid_data %>% 
   ...
   ggplot() +   
     ...
     labs(title = "COVID-19 Cases by age group",
          subtitle = "Missoula County, since March 2020", 
...
age_count_month_plot <- covid_data %>% 
   ...
   theme_minimal() +
   labs(title = "Monthly COVID-19 cases by age group",
        subtitle = "Missoula County, since March 2020",
        color = "Age group") +
...
age_incidence_plot_line <- covid_data %>% 
   ...
   ggplot() +
      geom_line(aes(month_of_year, group_inc, group = age_group, 
                    color = age_group), size = 1.5) +
   theme_minimal() +
   labs(title = "COVID-19 incidence per month by age group",
        subtitle = "Missoula County, since March 2020",
        color = "Age group") +
...
epi_curve_onset_recent <- covid_data %>% 
