...
covid_data <- read_rds(paste0(file_path, "Output/covid_data_clean.rds"))
   filter(symptom_onset_date >= "2020-06-01")

mean(covid_data$number_contacts, na.rm = TRUE)
median(covid_data$number_contacts, na.rm = TRUE)
range(covid_data$number_contacts, na.rm = TRUE)

table(covid_data$age_group, covid_data$number_contacts_categorical)
```
