...
date: "Started 2 April 2020, Updated 8 April 2020"
output:
...
Interpret R and doubling time with caution due to small sample size.
...
covid_plot_onset <- covid_data %>% 
   ...
   geom_text(aes(x = as.Date("2020-03-16"), label = "Schools close", vjust = -0.5,
                 y = 3.5), colour = "black", angle = 90, text = element_text(size=18)) +
