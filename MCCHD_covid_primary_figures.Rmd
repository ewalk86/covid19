...
covid_plot_age <- covid_data %>% 
   ggplot() +
     geom_col(aes(symptom_onset_date, case, fill = age_group), color = "black") +
...
covid_plot_gender <- covid_data %>% 
   ggplot() +
     geom_col(aes(symptom_onset_date, case, fill = gender), color = "black") +
...
covid_piechart <- plot_table %>% 
   ggplot(aes("", Freq, fill = hospitalized)) +
     ...
     geom_text(aes(label = paste0(group_percent, "%")), 
               ...
               color = "white", size = 6) +
     labs(title = "MCCHD COVID-19 infections", fill = "",
          subtitle = "Hospitalized cases with ventilators") + 
     theme_void() +
     theme(title = element_text(size = 16, colour = "black"),
           legend.text = element_text(size = 16, colour = "black"),
           legend.title = element_text(size = 16, colour = "black")) +
...
covid_piechart <- plot_table %>% 
   ggplot(aes("", Freq, fill = hospitalized)) +
     ...
     geom_text(aes(label = paste0(group_percent, "%")), 
               ...
               color = "white", size = 6) +
     labs(title = "MCCHD COVID-19 infections", fill = "",
          subtitle = "Hospitalized cases with chronic conditions") + 
     theme_void() +
     theme(title = element_text(size = 16, colour = "black"),
           legend.text = element_text(size = 16, colour = "black"),
           legend.title = element_text(size = 16, colour = "black")) +
