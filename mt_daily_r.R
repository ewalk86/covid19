...
state_dates_new <- state_dates_new[-1, 1:2]
...
state_r_plot <- state_r_clean %>% 
   ...
   labs(title = "COVID-19 Rolling Daily R-values, State of Montana, 2020",
        color = "") +
   ylab("R-value") +
   xlab("") +
...
state_r_plot <- reg1_r_clean %>% 
   ...
   geom_line(aes(dates, cl_low), size = 1.5, color = "grey") +
   geom_line(aes(dates, cl_high), size = 1.5, color = "grey") +
   labs(title = "COVID-19 Rolling Daily R-values, Montana Region 1, 2020",
        color = "") +
   ylab("R-value") +
   xlab("") +
   geom_hline(yintercept = 1, color = "black", size = 1.2) +
...
state_r_plot <- reg2_r_clean %>% 
   ...
   geom_line(aes(dates, cl_low), size = 1.5, color = "grey") +
   geom_line(aes(dates, cl_high), size = 1.5, color = "grey") +
   labs(title = "COVID-19 Rolling Daily R-values, Montana Region 2, 2020",
        color = "") +
   ylab("R-value") +
   xlab("") +
   geom_hline(yintercept = 1, color = "black", size = 1.2) +
...
state_r_plot <- reg3_r_clean %>% 
   ...
   geom_line(aes(dates, cl_low), size = 1.5, color = "grey") +
   geom_line(aes(dates, cl_high), size = 1.5, color = "grey") +
   labs(title = "COVID-19 Rolling Daily R-values, Montana Region 3, 2020",
        color = "") +
   ylab("R-value") +
   xlab("") +
   geom_hline(yintercept = 1, color = "black", size = 1.2) +
...
state_r_plot <- reg4_r_clean %>% 
   ...
   geom_line(aes(dates, cl_low), size = 1.5, color = "grey") +
   geom_line(aes(dates, cl_high), size = 1.5, color = "grey") +
   labs(title = "COVID-19 Rolling Daily R-values, Montana Region 4, 2020",
        color = "") +
   ylab("R-value") +
   xlab("") +
   geom_hline(yintercept = 1, color = "black", size = 1.2) +
...
state_r_plot <- reg5_r_clean %>% 
   ...
   geom_line(aes(dates, cl_low), size = 1.5, color = "grey") +
   geom_line(aes(dates, cl_high), size = 1.5, color = "grey") +
   labs(title = "COVID-19 Rolling Daily R-values, Montana Region 5, 2020",
        color = "") +
   ylab("R-value") +
   xlab("") +
   geom_hline(yintercept = 1, color = "black", size = 1.2) +
...
write_csv(all_regions_r, "C:/R/covid19/state_daily_results/all_regions_r_daily.csv", na = " ")
...
sftpUpload("elbastion.dbs.umt.edu", "celftp", "celftp",
           "/celFtpFiles/covid19/Rt/incoming/all_regions_r_daily.csv",
           "C:/R/covid19/state_daily_results/all_regions_r_daily.csv")
